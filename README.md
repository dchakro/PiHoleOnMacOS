...
Ads generate the revenue necessary for hosting content on the web and are a source of income for the developers. Which seems innocuous at first. However, when you think that a majority of theose ads are used for tracking your web activity and in future serving you more tailored advertisments. That is certainly something I did not want. So, I got inspired by a [Reddit thread](https://www.reddit.com/r/pihole/comments/9k6lzp/run_pihole_on_macos_mojave_with_docker/) by [/u/dudutwizer](https://www.reddit.com/user/dudutwizer/) to install [pihole](https://pi-hole.net) on my mac.
